...
export default {
  ...
  'PILE_DEFAULTS': {
    merchantColumns: [{
      label: 'YZSRD.ItemAvailability',
      path: 'system.availability',
      formatting: '{#}',
      buying: true,
      selling: true,
      // mapping: YZSRD.availabilities,
      mapping: {
        '5': 'YZSRD.ITEM_AVAILABILITY.Incidental',
        '4': 'YZSRD.ITEM_AVAILABILITY.Standard',
        '3': 'YZSRD.ITEM_AVAILABILITY.Premium',
        '2': 'YZSRD.ITEM_AVAILABILITY.Rare',
        '1': 'YZSRD.ITEM_AVAILABILITY.Luxury',
      },
    }, {
      label: '&nbsp;',
  ...
  'CURRENCIES': [
    {
      type: 'attribute',
      name: 'YZSRD.HEADER.ChinyenPoints',
  ...
  'SECONDARY_CURRENCIES': [
    {
      type: 'attribute',
      name: 'YZSRD.HEADER.PromotionPoints',
    ...
    {
      type: 'attribute',
      name: 'YZSRD.HEADER.HumanityPoints',
