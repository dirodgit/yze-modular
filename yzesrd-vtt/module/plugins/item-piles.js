import { AVAILABILITIES, ACTOR_TYPES, ITEM_TYPES } from '../system/constants.js';
...
export default {
  ...
  'PILE_DEFAULTS': {
    merchantColumns: [{
      label: 'YZE.ItemAvailability',
      path: 'system.availability',
      formatting: '{#}',
      buying: true,
      selling: true,
      // mapping: YZE.availabilities,
      mapping: {
        '5': 'YZE.ITEM_AVAILABILITY.Incidental',
        '4': 'YZE.ITEM_AVAILABILITY.Standard',
        '3': 'YZE.ITEM_AVAILABILITY.Premium',
        '2': 'YZE.ITEM_AVAILABILITY.Rare',
        '1': 'YZE.ITEM_AVAILABILITY.Luxury',
      },
    }, {
      label: '&nbsp;',
  ...
  'SECONDARY_CURRENCIES': [
    {
      type: 'attribute',
      name: 'YZE.HEADER.PromotionPoints',
    ...
    {
      type: 'attribute',
      name: 'YZE.HEADER.HumanityPoints',
