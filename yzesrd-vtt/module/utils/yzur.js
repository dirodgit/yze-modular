 ...
 * - `brD12`: Year Zero Engine SRD's D12 Die (locked on 1 and 10+)
 * - `brD10`: Year Zero Engine SRD's D10 Die (locked on 1 and 10)
 * - `brD8`: Year Zero Engine SRD's D8 Die (locked on 1 and 6+)
 * - `brD6`: Year Zero Engine SRD's D6 Die (locked on 1 and 6)
