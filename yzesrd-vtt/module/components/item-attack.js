...
export default class ItemAttack {
  ...
  get title() {
    return `<u>${this.name}</u><br/><span class="attack-description">[ `
      + `${game.i18n.localize('YZE.WeaponDamage')}: `
      + `<code>${this.damage}</code> `
      + `<em>${game.i18n.localize(CONFIG.YZE_MODULAR.damageTypes[this.damageType])}</em>,&nbsp;&nbsp;`
      + `${game.i18n.localize('YZE.CRIT.Crit')}: `
      + `<code>${game.i18n.localize('YZE.D')}${this.crit}</code>,&nbsp;&nbsp;`
      + `${game.i18n.localize('YZE.Range')}: `
      + `<code>${game.i18n.localize(CONFIG.YZE_MODULAR.ranges[this.range.max])}</code>`
      + ' ]</span>';
  }
