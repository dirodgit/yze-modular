  ...
  static getRangedCombatModifiers() {
    ...
    return [
      new Modifier(`${category}.outOfRange`, -1, {}, {
        active: false,
        name: game.i18n.localize('YZSRD.RANGED_COMBAT.OutOfRange'),
      }),
      new Modifier(`${category}.smallTarget`, -1, {}, {
        active: false,
        name: game.i18n.localize('YZSRD.RANGED_COMBAT.SmallTarget'),
      }),
      new Modifier(`${category}.largeTarget`, 1, {}, {
        active: false,
        name: game.i18n.localize('YZSRD.RANGED_COMBAT.LargeTarget'),
      }),
      new Modifier(`${category}.targetBehindCover`, -1, {}, {
        active: false,
        name: game.i18n.localize('YZSRD.RANGED_COMBAT.TargetBehindCover'),
      }),
      new Modifier(`${category}.carefulAim`, 1, {}, {
        active: false,
        name: game.i18n.localize('YZSRD.RANGED_COMBAT.CarefulAim'),
      }),
      new Modifier(`${category}.unseenTarget`, -1, {}, {
        active: false,
        name: game.i18n.localize('YZSRD.RANGED_COMBAT.UnseenTarget'),
      }),
    ];
  }
}
