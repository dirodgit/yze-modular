...
export default class CrewCollection extends foundry.utils.Collection {
  ...
  async choose(options = {}) {
    ...
    return chooseActor(this.contents, {
      title: options.title ?? `${this.vehicle.name}: ${game.i18n.localize('YZSRD.VEHICLE.ChoosePassenger')}`,
      notes: options.notes ?? game.i18n.localize('YZSRD.VEHICLE.ChoosePassengerHint'),
    });
  }
}
